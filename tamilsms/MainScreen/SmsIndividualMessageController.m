...
@interface SmsIndividualMessageController ()<individualMessageDelegate>
{
    UIBarButtonItem * _baradd_btn, *_barMinus_btn, *_barflex;
    individualMesssage * _individualmessage;
...
- (void)viewDidLoad
{
    ...
    self.navItem.rightBarButtonItems = [NSArray arrayWithObjects:_barMinus_btn, _barflex, _baradd_btn,nil];
