...
UILabel * (^__c_getStandardLabel)(NSString*) = ^(NSString * p_textVal)
{
    ...
    l_retlbl.textColor = [smsDefaults getDefaultTextColor];
...
UITextField * (^__c_getStandardTextField)() = ^()
{
    ...
    l_stdText.textColor = [smsDefaults getDefaultTextColor];
...
UIButton * (^__c_getStandardButton)() = ^()
{
    ...
    [l_stdbutton setTitleColor:[smsDefaults getDefaultTextColor] forState:UIControlStateNormal];
    return l_stdbutton;
};
