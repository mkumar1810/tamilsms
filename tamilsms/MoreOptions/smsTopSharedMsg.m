...
#import "smsTopSharedMsg.h"
#import "smsRESTProxy.h"

@interface smsTopSharedMsg ()
{
...
@implementation smsTopSharedMsg
...
- (void)viewDidLoad {
    ...
    [self.navigationItem setTitle:@"Top Shared Message"];
    [self initializeData];
...
{
    _pageNo = 1;
    [[smsRESTProxy alloc] initDatawithAPIType:@"TOP_SHARED_TEXT_MSG" andInputParams:@{@"page":@(_pageNo)} andReturnMethod:^(NSData * p_txtmsgsData){
        ...
        NSLog(@"Top Shared Text list data %@", l_receiveddict);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    smsTopSharedCell * l_cell = (smsTopSharedCell*) [tableView dequeueReusableCellWithIdentifier:l_CellIdentifier];
    if (l_cell == nil)
    {
        l_cell = [[smsTopSharedCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:l_CellIdentifier];
    }
...
@implementation smsTopSharedCell
