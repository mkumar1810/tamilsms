...
#import "smsLatstImgMessag.h"
#import "smsRESTProxy.h"
#import "smsAsyncImageFetch.h"

@interface smsLatstImgMessag ()
{
...
@implementation smsLatstImgMessag
...
- (void)viewDidLoad {
    ...
    [self.navigationItem setTitle:@"Latest Image"];
...
{
    _pageNo = 1;
    [[smsRESTProxy alloc] initDatawithAPIType:@"LATEST_IMG_MSG" andInputParams:@{@"page":@(_pageNo)} andReturnMethod:^(NSData * p_txtmsgsData){
...
//@end
//
//@implementation latestImageMsgCell
//
...
//{
//    if (loadMore) {
//        [loadMore setFrame:CGRectMake(5, 10, rect.size.width-10, 20)];
//        return;
//    }
