...
#import "smsTop25AuthorsText.h"
//#import "smsDBAsyncQueueProcess.h"
#import "smsRESTProxy.h"

@interface smsTop25AuthorsText ()
{
...
@implementation smsTop25AuthorsText
...
- (void)viewDidLoad {
    [super viewDidLoad];
//    [smsDBAsyncQueueProcess getTextMsgForCategory:1 andReturnCB:^(NSArray * p_txtMessage){
//        _txtMessages = p_txtMessage;
...
//    }];
    ...
    [self.navigationItem setTitle:@"Top 25 Authors Text"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    smsTop25AuthorsTextCell * l_cell = (smsTop25AuthorsTextCell*) [tableView dequeueReusableCellWithIdentifier:l_CellIdentifier];
    if (l_cell == nil)
    {
        l_cell = [[smsTop25AuthorsTextCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:l_CellIdentifier];
    }
...
@interface smsTop25AuthorsTextCell()
{
...
@implementation smsTop25AuthorsTextCell
