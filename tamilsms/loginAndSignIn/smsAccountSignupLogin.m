...
//  tamilsms
//
//  Created by arun benjamin on 01/10/15.
...
-(void)drawRect:(CGRect)rect
{
    ...
    [lbl_login setFont:[UIFont boldSystemFontOfSize:25]];
    ...
    [lbl_login addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[LB(60)]" options:0 metrics:nil views:@{@"LB":lbl_login}]];
    [lbl_login addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[LB(350)]" options:0 metrics:nil views:@{@"LB":lbl_login}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[LB]" options:0 metrics:nil views:@{@"LB":lbl_login}]];
    ...
    [lbl_username setFont:[UIFont boldSystemFontOfSize:18]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-90-[LU]" options:0 metrics:nil views:@{@"LU":lbl_username}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-130-[TU]" options:0 metrics:nil views:@{@"TU":txt_username}]];
    ...
    [lbl_password setFont:[UIFont boldSystemFontOfSize:18]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-170-[LU]" options:0 metrics:nil views:@{@"LU":lbl_password}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-210-[TP]" options:0 metrics:nil views:@{@"TP":txt_pasword}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-245-[LW]" options:0 metrics:nil views:@{@"LW":lbl_wrongIndi}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-275-[BL]" options:0 metrics:nil views:@{@"BL":but_login}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-320-[BC]" options:0 metrics:nil views:@{@"BC":but_changPass}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-365-[BN]" options:0 metrics:nil views:@{@"BN":but_newAcc}]];
    ...
    [lbl_agre setFont:[UIFont boldSystemFontOfSize:15]];
    ...
    [lbl_agre addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[LA(100)]" options:0 metrics:nil views:@{@"LA":lbl_agre}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-405-[LA]" options:0 metrics:nil views:@{@"LA":lbl_agre}]];
    ...
    [lbl_cntpolicy addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[CP(110)]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-405-[CP]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[LA]-0-[CP]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy,@"LA":lbl_agre}]];

    
    lbl_coma = [UILabel new];
    [lbl_coma setText:@","];
    [lbl_coma setFont:[UIFont boldSystemFontOfSize:15]];
    [lbl_coma setTextAlignment:NSTextAlignmentLeft];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-405-[CO]" options:0 metrics:nil views:@{@"CO":lbl_coma}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[LA]-0-[CP]-0-[CO]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy,@"LA":lbl_agre,@"CO":lbl_coma}]];
    
    lbl_termCondi = [UILabel new];
    [lbl_termCondi setFont:[UIFont boldSystemFontOfSize:15]];
    [lbl_termCondi setTextAlignment:NSTextAlignmentLeft];
    [lbl_termCondi setTextColor:[UIColor blackColor]];
    //[lbl_termCondi setBackgroundColor:[UIColor redColor]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-405-[TC]" options:0 metrics:nil views:@{@"TC":lbl_termCondi}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[LA]-0-[CP]-0-[CO]-0-[TC]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy,@"LA":lbl_agre,@"CO":lbl_coma,@"TC":lbl_termCondi}]];
    
    lbl_and = [UILabel new];
    [lbl_and setText:@"and"];
    [lbl_and setFont:[UIFont boldSystemFontOfSize:15]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-405-[LAN]" options:0 metrics:nil views:@{@"LAN":lbl_and}]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-15-[LA]-0-[CP]-0-[CO]-0-[TC]-0-[LAN]" options:0 metrics:nil views:@{@"CP":lbl_cntpolicy,@"LA":lbl_agre,@"CO":lbl_coma,@"TC":lbl_termCondi,@"LAN":lbl_and}]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-425-[LPR]" options:0 metrics:nil views:@{@"LPR":lbl_privacy}]];
